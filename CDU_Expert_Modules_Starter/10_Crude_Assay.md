...
- Required crude assay inputs (TBP, density, sulfur, MW, viscosity if available)
- Validate assay completeness
- Pseudo-component generation checks
- Feed blend reasoning
- Failure modes
- Decision tree
- Manipulated variables: none until assay accepted
